...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleBusiness(BusinessException e) {
        ...
        recordHttpErrorMetric(e.getErrorCode().name(), e.getErrorCode().getStatus());
    ...
    public ResponseEntity<ApiErrorResponse> handleEmail(EmailException e) {
        ...
        recordHttpErrorMetric(e.getEmailErrorCode().name(), e.getEmailErrorCode().getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handlePhoneVerification(PhoneVerificationException e) {
        ...
        recordHttpErrorMetric(e.getPhoneErrorCode().name(), e.getPhoneErrorCode().getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleMissingPerson(MissingPersonException e) {
        ...
        recordHttpErrorMetric(e.getMissingPersonErrorCode().name(), e.getMissingPersonErrorCode().getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleValidation(Exception e) {
        ...
        recordHttpErrorMetric(ErrorCode.VALIDATION_ERROR.name(), ErrorCode.VALIDATION_ERROR.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleMissingRequestParameter(MissingServletRequestParameterException e) {
        ...
        recordHttpErrorMetric("MISSING_PARAMETER", ErrorCode.VALIDATION_ERROR.getStatus());
        return ResponseEntity
                .status(ErrorCode.VALIDATION_ERROR.getStatus())
    ...
    public ResponseEntity<ApiErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException e) {
        ...
        recordHttpErrorMetric("TYPE_MISMATCH", ErrorCode.VALIDATION_ERROR.getStatus());
        return ResponseEntity
                .status(ErrorCode.VALIDATION_ERROR.getStatus())
    ...
    public ResponseEntity<ApiErrorResponse> handleAuthentication(AuthenticationException e) {
        ...
        recordHttpErrorMetric(ErrorCode.AUTH_ERROR.name(), ErrorCode.AUTH_ERROR.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleAccessDenied(AccessDeniedException e) {
        ...
        recordHttpErrorMetric(ErrorCode.FORBIDDEN.name(), ErrorCode.FORBIDDEN.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleNotFound(NoHandlerFoundException e) {
        ...
        recordHttpErrorMetric(ErrorCode.NOT_FOUND.name(), ErrorCode.NOT_FOUND.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleNoResourceFound(NoResourceFoundException e) {
        ...
        recordHttpErrorMetric("ENDPOINT_NOT_FOUND", ErrorCode.NOT_FOUND.getStatus());
        return ResponseEntity
                .status(ErrorCode.NOT_FOUND.getStatus())
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodNotSupported(HttpRequestMethodNotSupportedException e) {
        ...
        recordHttpErrorMetric(ErrorCode.METHOD_NOT_ALLOWED.name(), ErrorCode.METHOD_NOT_ALLOWED.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleDataAccess(DataAccessException e) {
        ...
        recordHttpErrorMetric("DATABASE_ERROR", ErrorCode.INTERNAL_ERROR.getStatus());
        return ResponseEntity
    ...
    public ResponseEntity<ApiErrorResponse> handleGeneral(Exception e) {
        ...
        recordHttpErrorMetric(ErrorCode.INTERNAL_ERROR.name(), ErrorCode.INTERNAL_ERROR.getStatus());
        return ResponseEntity
                .status(ErrorCode.INTERNAL_ERROR.getStatus())
                .body(ApiErrorResponse.of(ErrorCode.INTERNAL_ERROR));
    }

    private void recordHttpErrorMetric(String errorType, int statusCode) {
        try {
            metricsService.recordHttpError(errorType, statusCode);
        } catch (Exception metricException) {
            log.debug("HTTP 에러 메트릭 기록 실패 - type: {}, status: {}", errorType, statusCode, metricException);
        }
    }
}
