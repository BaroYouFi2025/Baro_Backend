...
@Data
public class MissingPersonPoliceDetailResponse {
    ...
    public static MissingPersonPoliceDetailResponse from(MissingPersonPolice entity) {
        MissingPersonPoliceDetailResponse response = new MissingPersonPoliceDetailResponse();
